...
- Update book module compatibility to version 3
...
9.1.4
--------------------------------------------------------------------------------
_Release Date: 2026-05-06_

- Apply preact filters only once (#81)
- Tweak views ajax to prevent breaking on D11.3

9.1.3
--------------------------------------------------------------------------------
_Release Date: 2025-11-17_

- Bugfix: Remove localist urls with no filters

9.1.2
--------------------------------------------------------------------------------
_Release Date: 2025-10-10_

- Fix preact combo box BEF for single select lists.

9.1.1
--------------------------------------------------------------------------------
_Release Date: 2025-09-23_

- Allow for optional custom font awesome icon field help text
